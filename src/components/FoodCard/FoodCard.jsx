...
export function FoodCard({ name, price, image }) {
    ...
    return (
        <div className="group overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border rounded-lg bg-white dark:bg-gray-800 shadow-sm">
            ...
            <div className="p-4">
                ...
                <button onClick={() =>handleOrderItem(name, price, image)} className="w-full py-3 px-4 flex items-center justify-center bg-zinc-900 hover:bg-zinc-800 dark:bg-zinc-50 dark:hover:bg-zinc-200 text-zinc-50 dark:text-zinc-900 transition-colors rounded-md font-medium">
